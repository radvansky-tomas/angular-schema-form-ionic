...
$templateCache.put("decorators/ionic/item.html","<ion-item ng-attr-layout=\"{{form.layoutClass}}\" ng-attr-self=\"{{form.selfClass}}\" class=\"{{::form.htmlClass}}\"></ion-item>");
$templateCache.put("decorators/ionic/list.html","<ion-list ng-attr-layout=\"{{form.layoutClass}}\" ng-attr-self=\"{{form.selfClass}}\" class=\"{{::form.htmlClass}}\"></ion-list>");
...
$templateCache.put("decorators/ionic/section.html","<div ng-attr-layout=\"{{form.layoutClass}}\" ng-attr-self=\"{{form.selfClass}}\" class=\"schema-form-section {{::form.htmlClass + \' \' + idClass}}\" sf-key-controller=\"\" sf-parent-key=\"[{{form.key.join(\'][\')}}]\" sf-index=\"{{$index}}\"></div>");
...
$templateCache.put("decorators/ionic/separator.html","<div ng-attr-layout=\"{{form.layoutClass}}\" ng-attr-self=\"{{form.selfClass}}\" class=\"schema-form-separator item item-divider {{::form.htmlClass + \' \' + idClass}}\" sf-key-controller=\"\" ng-show=\"showTitle()\">{{ form.title }}</div>");
