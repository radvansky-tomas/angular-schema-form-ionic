...
$templateCache.put("decorators/ionic/item.html","<ion-item ng-attr-layout=\"{{form.layoutFlex}}\" ng-attr-self=\"{{form.selfFlex}}\" class=\"{{::form.htmlClass}}\"></ion-item>");
$templateCache.put("decorators/ionic/list.html","<ion-list ng-attr-layout=\"{{form.layoutFlex}}\" ng-attr-self=\"{{form.selfFlex}}\" class=\"{{::form.htmlClass}}\"></ion-list>");
...
$templateCache.put("decorators/ionic/range-directive.html","<div ng-attr-layout=\"{{form.layoutFlex}}\" ng-attr-self=\"{{form.selfFlex}}\"><div ng-attr-self=\"{{form.labelFlexClass}}\" ng-show=\"showTitle()\" class=\"input-label {{form.labelHtmlClass}}\">{{form.title}}</div><input ng-attr-self=\"{{form.fieldFlex}}\" custom-range=\"\" step=\"modelValue.step\" value=\"modelValue.value\" desc=\"modelValue.desc\" map=\"form.titleMap\" ng-model=\"modelValue.step\" ng-class=\"form.fieldHtmlClass\" ng-disabled=\"form.readonly\" name=\"{{form.key.slice(-1)[0]}}\" min=\"{{form.min}}\" max=\"{{form.max}}\" type=\"range\"> <input ng-attr-self=\"{{form.numberFlex}}\" ng-class=\"form.numberHtmlClass\" style=\"max-width: 50px; text-align: center; background-position: bottom\" type=\"text\" maxlength=\"3\" ng-disabled=\"true\" ng-model=\"modelValue.value\"> <span ng-attr-self=\"{{form.descFlex}}\" ng-class=\"form.descHtmlClass\" ng-model=\"modelValue.desc\" ng-if=\"modelValue.desc\" model-to-html=\"\"></span></div>");
$templateCache.put("decorators/ionic/range.html","<label for=\"{{form.key.slice(-1)[0]}}\" class=\"item item-input range range-positive schema-form-range {{form.htmlClass}}\" ng-class=\"{\'has-error\': hasError(), \'has-success\': hasSuccess(), \'has-feedback\': form.feedback !== false}\"><hidden-div sf-field-model=\"\" schema-validate=\"form\" form-object=\"form\"></hidden-div><p class=\"help-block {{form.errorClass}}\" sf-message=\"form.description\"></p></label>");
$templateCache.put("decorators/ionic/section.html","<div ng-attr-layout=\"{{form.layoutFlex}}\" ng-attr-self=\"{{form.selfFlex}}\" class=\"schema-form-section {{::form.htmlClass + \' \' + idClass}}\" sf-key-controller=\"\" sf-parent-key=\"[{{form.key.join(\'][\')}}]\" sf-index=\"{{$index}}\"></div>");
...
$templateCache.put("decorators/ionic/separator.html","<div ng-attr-layout=\"{{form.layoutFlex}}\" ng-attr-self=\"{{form.selfFlex}}\" class=\"schema-form-separator item item-divider {{::form.htmlClass + \' \' + idClass}}\" sf-key-controller=\"\" ng-show=\"showTitle()\">{{ form.title }}</div>");
        ...
        link: function (scope, element, attrs, ngModel) {
            scope.$watch(function () {
                ...
                if (newValue !== undefined) {
                    ngModel.$modelValue = scope.modelValue; //assign back
                }
            });
        }
    };
